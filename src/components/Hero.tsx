...
Je vous souhaite une agréable lecture !
            ...
            <div className="flex gap-4">
              ...
              <div className="flex gap-4">
                <a href="https://github.com/Yuno35300" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  <Github size={24} />
                </a>
                <a href="https://www.linkedin.com/in/kylian-cheroret-b19188282/?originalSubdomain=fr" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  <Linkedin size={24} />
                </a>
