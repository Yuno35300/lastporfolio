...
const Timeline = () => {
  const timelineItems: TimelineItem[] = [
    ...
    },
    {
      ...
      description: "Support technique niveau 1 et 2, maintenance du parc informatique.",
      type: "work",
      parallel: {
        title: "Barman / Serveur",
        subtitle: "Le Café de Paris,Pti vélo,....",
        description: "Service client, gestion des commandes, préparation des boissons et maintien de l'ambiance du bar, et du service.",
        type: "work"
      }
    },
    {
